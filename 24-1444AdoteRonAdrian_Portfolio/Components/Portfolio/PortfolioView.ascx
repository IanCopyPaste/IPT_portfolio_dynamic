<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PortfolioView.ascx.cs" Inherits="_24_1444AdoteRonAdrian_Portfolio.Components.Portfolio.PortfolioView" %>
<%-- The portfolio itself: the navbar and every section, drawn from one account's row. ContentPage
     shows it to its signed-in owner and SharePage to anyone holding the link, so the two pages
     can never drift apart. Shared leaves out what only the owner has a use for: the account button
     and the contact form, which sends nowhere yet. --%>
...
<main>
    ...
    <section id="about" class="section about-section">
        <div class="section-inner">
            ...
            <div class="about-panels">
                <%-- Every value below is the owner's own, and every one of them
    ...
    <section id="contact" class="section contact-section">
        <div class="section-inner">
            ...
            <% if (Shared) { %>
            <%-- Only the owner's own details: no form to send from, and none of the owner-page
                 copy about reply times, which is the site's wording rather than theirs. --%>
                ...
                <div class="contact-info reveal" data-reveal-delay="120">
                    ...
                    <dl class="contact-facts">
                        <div class="contact-fact">
                            <dt>Email</dt>
                            <dd class="<%= UnsetClass(Owner.Email) %>"><%: Or(Owner.Email) %></dd>
                        </div>
                        <div class="contact-fact">
                            <dt>Mobile</dt>
                            <dd class="<%= UnsetClass(Owner.Sms) %>"><%: Or(Owner.Sms) %></dd>
                        </div>
                        <div class="contact-fact">
                            <dt>Based in</dt>
